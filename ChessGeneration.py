...
w_pawn_img = pygame.image.load("Sprites/w_pawn.png")
b_pawn_img = pygame.image.load("Sprites/b_pawn.png")
w_rook_img = pygame.image.load("Sprites/w_rook.png")
b_rook_img = pygame.image.load("Sprites/b_rook.png")
w_knight_img = pygame.image.load("Sprites/w_knight.png")
b_knight_img = pygame.image.load("Sprites/b_knight.png")
w_bishop_img = pygame.image.load("Sprites/w_bishop.png")
b_bishop_img = pygame.image.load("Sprites/b_bishop.png")
w_king_img = pygame.image.load("Sprites/w_king.png")
b_king_img = pygame.image.load("Sprites/b_king.png")
w_queen_img = pygame.image.load("Sprites/w_queen.png")
b_queen_img = pygame.image.load("Sprites/b_queen.png")
